...
class BlueBlob(Blob):
    ...
    def __init__(self, x_boundary, y_boundary):
        ...
        #Blob.__init__(self, color, x_boundary, y_boundary) <--- The same as before
        #But has no inheritance, that means: if we have more than one class, can produce problems
